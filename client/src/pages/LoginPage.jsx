      ...
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/40 border border-gray-100 p-8 md:p-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-xs font-medium mt-1">Sign in to your YatriGo account</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleFormSubmit}>
            ...
            <div className="space-y-1.5">
               <div className="flex justify-between items-center px-1">
                  <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Secret Key</label>
                  <button type="button" className="text-[9px] font-black text-rose-500 uppercase tracking-widest hover:underline">Forgot?</button>
               </div>
               <div className="relative group">
          ...
          <div className="my-8 flex items-center gap-4">
            ...
            <p className="text-[9px] font-black text-gray-300 uppercase tracking-widest">Alternative Access</p>
            <div className="h-px grow bg-gray-100"></div>
          </div>
          ...
          <div className="text-center pt-6 border-t border-gray-50">
            <p className="text-gray-400 text-xs font-medium">
              New to the circle?{' '}
              <Link className="text-rose-500 font-black uppercase tracking-tighter hover:underline" to={'/register'}>
                Join YatriHub
              </Link>
            </p>
          </div>
