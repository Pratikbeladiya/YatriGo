...
const CarHero = ({ externalSearch }) => {
  ...
  useEffect(() => {
    if (externalSearch && (externalSearch.location || externalSearch.category)) {
      if (externalSearch.location) {
        setLocation(externalSearch.location);
        setSearched(true);
        searchCars(externalSearch.location, {});
      } else if (externalSearch.category) {
         if (externalSearch.category === 'Electric') {
           setFuelType('Electric');
           setSearched(true);
           searchCars('', { fuelType: 'Electric' });
         } else if (externalSearch.category === 'Economy') {
           setMaxPrice('3000');
           setSearched(true);
           searchCars('', { maxPrice: '3000' });
         } else {
           setSearched(true);
           searchCars('', {});
         }
