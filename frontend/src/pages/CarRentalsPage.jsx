...
const CarRentalsPage = () => {
  const [externalSearch, setExternalSearch] = useState({ location: '', category: '' });

  return (
    <div className="pt-20 pb-20 font-sans bg-gray-50/30">
      <CarHero externalSearch={externalSearch} />
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
              {[
                ...
                <div key={city.name} onClick={() => setExternalSearch({ location: city.name, category: '' })} className="group cursor-pointer">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
              {[
                ...
                <div key={type.name} onClick={() => setExternalSearch({ location: '', category: type.name })} className="group cursor-pointer">
                  <div className="relative aspect-[4/3] overflow-hidden rounded-xl shadow-sm border border-gray-100 group-hover:shadow-md transition">
