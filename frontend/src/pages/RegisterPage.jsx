...
import { User, Mail, Lock, ArrowRight, Plane } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100/80 p-8 md:p-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="font-display text-3xl font-bold text-gray-900 tracking-tight">Create account</h1>
            <p className="text-gray-500 text-sm font-normal mt-2">Start your travel adventure today</p>
          </div>
          ...
          <div className="my-7 flex items-center gap-4">
            ...
            <p className="text-xs font-medium text-gray-400">or sign up with</p>
            <div className="h-px grow bg-gray-100" />
          </div>
          ...
          <div className="text-center pt-6 border-t border-gray-50">
            <p className="text-gray-500 text-sm">
              ...
              <Link className="text-rose-500 font-semibold hover:text-rose-600 transition-colors" to={'/login'}>
                Sign in
              </Link>
            </p>
          </div>
